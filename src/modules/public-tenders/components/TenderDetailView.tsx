  ...
  return (
    <div className="space-y-8 max-w-5xl">
      ...
      <section className="p-6 bg-gallery-surface border border-gallery-border rounded-lg space-y-5 shadow-2xs">
        ...
        {scopeAndSpec ? (
          <div className="space-y-5 text-xs text-gallery-charcoal">
            {/* What Buyer Wants */}
            ...
            {/* Required Services & Key Deliverables */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2 p-3.5 bg-gallery-canvas rounded border border-gallery-border">
                ...
                <ul className="space-y-1.5">
                  {scopeAndSpec.requiredServices.map((svc: string, idx: number) => (
              ...
              <div className="space-y-2 p-3.5 bg-gallery-canvas rounded border border-gallery-border">
                ...
                <ul className="space-y-1.5">
                  {scopeAndSpec.keyDeliverables.map((del: string, idx: number) => (
                    <li key={idx} className="flex items-start gap-2 text-[11px]">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="p-3 bg-gallery-canvas rounded border border-gallery-border space-y-1">
                ...
                <p className="text-[11px] leading-relaxed">{scopeAndSpec.locations.join(', ')}</p>
              </div>
            </div>

            {/* Creative Overlap vs Outside Core Capability */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
              <div className="p-3.5 bg-emerald-50/70 border border-emerald-200 rounded space-y-2">
                <h4 className="text-[11px] font-mono font-bold uppercase text-emerald-900 flex items-center gap-1.5">
                  <Sparkles className="w-3.5 h-3.5 text-emerald-600" />
                  <span>Adrastichyperlink Creative Overlap</span>
                </h4>
                <ul className="space-y-1">
                  {scopeAndSpec.creativeMarketingDigitalOverlap.map((co: string, idx: number) => (
                    <li key={idx} className="flex items-start gap-1.5 text-[11px] text-emerald-950">
                      <span className="text-emerald-600 font-bold">✓</span>
                      <span>{co}</span>
                    </li>
                  ))}
              ...
              <div className="p-3.5 bg-amber-50/70 border border-amber-200 rounded space-y-2">
                <h4 className="text-[11px] font-mono font-bold uppercase text-amber-900 flex items-center gap-1.5">
                  ...
                  <span>Services Outside Core Capability</span>
                </h4>
                <ul className="space-y-1">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5">
                  {scopeAndSpec.importantDates.map((d: any, idx: number) => (
                    <div key={idx} className="p-2.5 bg-gallery-canvas border border-gallery-border rounded">
                      <div className="text-[10px] font-mono text-gallery-muted">{d.label}</div>
          ...
          <div className="space-y-3">
            ...
            <div className="p-3 bg-gallery-canvas border border-gallery-border rounded text-xs text-gallery-muted font-mono">
              Detailed scope has not yet been published in the currently available procurement material. Click &quot;ANALYSE TENDER&quot; above to synthesize procurement intelligence.
            </div>
          </div>
        )}
      </section>
