import { TenderSummary, TenderRequirement, TenderDocumentItem } from '../types/tender';
...
export interface ReviewTenderDetail extends TenderSummary {
  ...
  evaluationCriteria: { criterion: string; weightingPercentage: number }[];
    ...
    requirements: [
      {
        ...
        adrasticCapabilityText: 'Hiscox Policy #92819 — £2,000,000 active cover',
        status: 'PASS',
        mandatory: true,
      },
      {
        ...
        adrasticCapabilityText: 'Hiscox Policy #92819 — £5,000,000 active cover',
        status: 'PASS',
        mandatory: true,
      },
      {
    ...
    requirements: [
      {
        ...
        adrasticCapabilityText: 'Hiscox £2m cover exceeds requirement',
        status: 'PASS',
        mandatory: true,
      },
    ],
